ALGOL60_VERSION := $(shell cat ALGOL60_VERSION)
ALGOL60_DEPS := $(wildcard ALGOL60_*)
DOCKER_TAG_PREFIX := rzuckerm/algol60:$(ALGOL60_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(ALGOL60_DEPS)
...
$(META_BUILDX_TARGET): $(META_CREATE_BUILDER_TARGET) Dockerfile Makefile $(ALGOL60_DEPS)
